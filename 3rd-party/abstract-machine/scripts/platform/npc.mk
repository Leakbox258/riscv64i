...
LDSCRIPTS += $(ABSTRACT_MACHINE_DIR)/scripts/linker.ld
...
insert-arg: image
	@python $(ABSTRACT_MACHINE_DIR)/tools/insert-arg.py $(IMAGE).bin $(MAINARGS_MAX_LEN) $(MAINARGS_PLACEHOLDER) "$(mainargs)"
